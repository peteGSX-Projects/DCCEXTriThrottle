...
ThrottleMenuItem::ThrottleMenuItem(Menu *menu, int throttleIndex, const char *name, bool isProgmem)
    : SubMenuItem(menu, name, isProgmem), _throttleIndex(throttleIndex) {}
