...
// Set default time in ms for waiting between speed updates to avoid spamming the CS and other throttles
#ifndef SPEED_CHANGE_DELAY
#define SPEED_CHANGE_DELAY 100
#endif // SPEED_CHANGE DELAY
